...
<div id="add-subtotal-modal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden">
    ...
    <div class="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-xl w-full max-w-sm">
        ...
        <div class="flex justify-between items-center p-4 border-b">
            ...
            <button id="close-subtotal-modal-btn" type="button" class="text-gray-400 hover:text-gray-600 text-3xl leading-none">×</button>
        </div>
